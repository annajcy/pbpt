...
TEST(BxDFTest, MakeRayDifferentialOffsetNonSpecularReturnsNullopt) {
    ...
    geometry::SurfaceInteraction<Float> si(
        Point<Float, 3>(0, 0, 0),
        Vector<Float, 3>(0, 0, 1),
        Normal<Float, 3>(0, 0, 1),
        Point<Float, 2>(0, 0),
        Vector<Float, 3>(1, 0, 0),
        Vector<Float, 3>(0, 1, 0)
    );
    geometry::ShadingInfo<Float> shading{
        Normal<Float, 3>(0, 0, 1),
    ...
    auto offset = make_ray_differential_offset(
