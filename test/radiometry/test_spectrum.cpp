...
TEST_F(SpectrumTest, UnboundedRGBSpectrumWorkflow) {
    ...
    RGBUnboundedSpectrumDistribution<double, RGBSigmoidPolynomialNormalized> unbounded_spectrum(
        optimized_poly, scaled_result.scale);
...
TEST_F(SpectrumTest, IlluminantSpectrumDistributionBasic) {
    ...
    for (double scale : test_scales) {
        ...
        RGBUnboundedSpectrumDistribution<double, RGBSigmoidPolynomialNormalized> 
            illuminant_spectrum(optimized_albedo_poly, scale);
