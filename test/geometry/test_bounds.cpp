...
TEST(BoundingBoxTest, ChainedUnitedOperations) {
    ...
    Bounds<Float, 3> result = box.united(Pt3(0.0, 0.0, 0.0)).united(Pt3(2.0, 2.0, 2.0)).united(Pt3(3.0, 3.0, 3.0));
...
TEST(BoundingBoxTest, RayBoundsIntersection_OriginInsideAllAxes) {
    ...
    std::vector<TestCase> test_cases = {{Vec3(1.0, 0.0, 0.0), 0.7f, "+X"}, {Vec3(-1.0, 0.0, 0.0), 0.3f, "-X"},
                                        {Vec3(0.0, 1.0, 0.0), 0.6f, "+Y"}, {Vec3(0.0, -1.0, 0.0), 0.4f, "-Y"},
                                        {Vec3(0.0, 0.0, 1.0), 0.4f, "+Z"}, {Vec3(0.0, 0.0, -1.0), 0.6f, "-Z"}};
...
TEST(BoundingBoxTest, RayBoundsIntersection_OriginInsideVerifyRayPoints) {
    ...
    Ray<Float, 3> ray(origin, Vec3(1.0, 0.0, 0.0), std::numeric_limits<Float>::infinity(),
