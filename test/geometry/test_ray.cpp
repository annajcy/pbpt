...
RayDiff3 make_default_ray_diff3() {
    Ray3 main_ray;
    std::array<Ray3, 2> diff_rays = {Ray3(Point<double, 3>(1e-3, 0.0, 0.0), Vector<double, 3>(1.0, 0.1, 0.0)),
...
RayDiff2 make_default_ray_diff2() {
    Ray2 main_ray;
    std::array<Ray2, 1> diff_rays = {Ray2(Point<double, 2>(0.0, 1e-3), Vector<double, 2>(1.0, 0.1))};
...
TEST_F(RayDifferentialTest, ParameterizedConstruction) {
    ...
    std::array<Ray3, 2> diff_rays = {Ray3(Pt3(1.1, 2.0, 3.0), Vec3(1.0, 0.1, 0.0)),
...
TEST_F(RayDifferentialTest, UniformScaling) {
    ...
    std::array<Ray3, 2> diff_rays = {Ray3(Pt3(0.1, 0.0, 0.0), Vec3(1.0, 0.1, 0.0)),
...
TEST_F(RayDifferentialTest, ScalingMathematicalCorrectness) {
    ...
    std::array<Ray3, 2> diff_rays = {Ray3(Pt3(10.5, 20.0, 30.0), Vec3(0.1, 0.0, 1.0)),
...
TEST_F(RayDifferentialTest, ScalingWithDifferentTypes) {
    Ray3 main_ray(Pt3(0.0, 0.0, 0.0), Vec3(1.0, 0.0, 0.0));
    std::array<Ray3, 2> diff_rays = {Ray3(Pt3(1.0, 0.0, 0.0), Vec3(1.0, 0.0, 0.0)),
...
TEST_F(RayDifferentialTest, ScalingEdgeCases) {
    ...
    std::array<Ray3, 2> diff_rays = {Ray3(Pt3(6.0, 5.0, 5.0), Vec3(1.0, 0.1, 0.0)),
...
TEST_F(RayDifferentialTest, ScaledConstCorrectness) {
    ...
    std::array<Ray3, 2> diff_rays = {Ray3(Pt3(1.5, 2.0, 3.0), Vec3(0.1, 1.0, 0.0)),
...
TEST_F(RayDifferentialTest, ScaledVsScaleEquivalence) {
    ...
    std::array<Ray3, 2> diff_rays = {Ray3(Pt3(5.2, 10.0, 15.0), Vec3(0.1, 0.0, 1.0)),
...
TEST_F(RayDifferentialTest, ScaledDifferentTypes) {
    Ray3 main_ray(Pt3(0.0, 0.0, 0.0), Vec3(1.0, 0.0, 0.0));
    std::array<Ray3, 2> diff_rays = {Ray3(Pt3(2.0, 0.0, 0.0), Vec3(1.0, 0.0, 0.0)),
