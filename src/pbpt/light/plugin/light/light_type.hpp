...
template <typename T>
using StandardAreaLightType = light::AreaLight<T, shape::Triangle<T>, radiometry::StandardEmissionSpectrum<T>>;

template <typename T>
using AnyLight = std::variant<StandardAreaLightType<T>>;
