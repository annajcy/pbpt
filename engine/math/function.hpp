 ...
 * @details This function checks if `a - b` is greater than a predefined epsilon (`EPSILON`).
 * @tparam T Floating-point type of the values.
 * @param a The first value.
 * @param b The second value.
...
/**
 * @brief Compares if `a` is less than or equal to `b`.
 * @details This function checks if `b - a` is greater than a predefined epsilon (`EPSILON`).
 * @tparam T Floating-point type of the values.
 * @param a The first value.
 * @param b The second value.
 * @return `true` if `b - a > EPSILON`, `false` otherwise.
 */
template <typename T>
requires std::is_floating_point_v<T>
...
/**
 * @brief Compares if `a` is less than `b`.
 * @details This function checks if `b - a` is greater than a predefined epsilon (`EPSILON`).
 * @tparam T Floating-point type of the values.
 * @param a The first value.
 * @param b The second value.
...
/**
 * @brief Compares if `a` is greater than or equal to `b`.
 * @details This function checks if `a - b` is greater than a predefined epsilon (`EPSILON`).
 * @tparam T Floating-point type of the values.
 * @param a The first value.
 * @param b The second value.
